# -*- encoding: utf-8 -*-
# stub: activerecord-nulldb-adapter 0.7.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<activerecord>.freeze, [">= 5.2.0", "< 6.3"])
    ...
    s.add_dependency(%q<activerecord>.freeze, [">= 5.2.0", "< 6.3"])
