...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<airbrake-ruby>.freeze, ["~> 5.1"])
    ...
    s.add_development_dependency(%q<redis>.freeze, ["= 4.1.4"])
    ...
    s.add_development_dependency(%q<ethon>.freeze, ["= 0.12.0"])
    s.add_development_dependency(%q<public_suffix>.freeze, ["~> 4.0", "< 5.0"])
    s.add_development_dependency(%q<redis-namespace>.freeze, ["= 1.6.0"])
  else
    s.add_dependency(%q<airbrake-ruby>.freeze, ["~> 5.1"])
    ...
    s.add_dependency(%q<redis>.freeze, ["= 4.1.4"])
    ...
    s.add_dependency(%q<ethon>.freeze, ["= 0.12.0"])
    s.add_dependency(%q<public_suffix>.freeze, ["~> 4.0", "< 5.0"])
